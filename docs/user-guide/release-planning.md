...
The `-e` and `--extract` flags will be replaced by an extensible processor system. If you currently use these flags to extract CSS code from HTML files, then please consider [building a processor](https://github.com/stylelint/stylelint/blob/v7/docs/developer-guide/processors.md) for the community.
