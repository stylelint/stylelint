...
3. Check if [package tests in the ecosystem](https://github.com/stylelint/stylelint-ecosystem-tester#readme) fail with the new version.
4. If necessary, test `main` locally in the:
