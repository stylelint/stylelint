...
Have a look at the [rules user guide](../user-guide/configuration/about-rules.md) to familiarize yourself the rule naming conventions.
...
-   [The list of rules](../user-guide/configuration/rules.md)
-   [The example config](../user-guide/configuration/example-config.md)
