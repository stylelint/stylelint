...
The [specificity](https://drafts.csswg.org/selectors-4/#specificity-rules) of the [nesting selector](https://drafts.csswg.org/css-nesting/#nesting-selector) (`&`) is equal to the largest specificity among the complex selectors in the parent's selector list (identical to the behavior of [:is()](https://drafts.csswg.org/selectors-4/#matches-pseudo)).
...
The specificity of `& a` is `1,0,1` because `#foo` has a larger specificity than `.bar`:
