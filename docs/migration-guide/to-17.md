...
You can follow the [advice above](#removed-commonjs-nodejs-api) to either migrate your plugin to ESM to modernise your plugin or use `require("stylelint").default` in your CommonJS plugin to consume the ESM Node.js API.
