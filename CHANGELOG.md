...
- Fixed: `selector-no-invalid` false negatives for pseudo-elements, combinators and nested `:has()` ([#9452](https://github.com/stylelint/stylelint/pull/9452)) ([@jeddy3](https://github.com/jeddy3)).
