...
/** @type {ReadonlySet<string>} */
export const displayInsideKeywords = new Set(['flow', 'flow-root', 'table', 'flex', 'grid', 'ruby']);

/** @type {ReadonlySet<string>} */
export const displayLegacyKeywords = new Set(['inline-block', 'inline-table', 'inline-flex', 'inline-grid']);
