...
/** @typedef {object} KeywordSets
 * @property {Set<string>} nonLengthUnits
 * @property {Set<string>} lengthUnits
 * @property {Set<string>} units
 * @property {Set<string>} colorFunctionNames
 * @property {Set<string>} camelCaseFunctionNames
 * @property {Set<string>} basicKeywords
 * @property {Set<string>} systemFontValues
 * @property {Set<string>} fontFamilyKeywords
 * @property {Set<string>} fontWeightRelativeKeywords
 * @property {Set<string>} fontWeightAbsoluteKeywords
 * @property {Set<string>} fontWeightNumericKeywords
 * @property {Set<string>} animationNameKeywords
 * @property {Set<string>} animationTimingFunctionKeywords
 * @property {Set<string>} animationIterationCountKeywords
 * @property {Set<string>} animationDirectionKeywords
 * @property {Set<string>} animationFillModeKeywords
 * @property {Set<string>} animationShorthandKeywords
 * @property {Set<string>} animationPlayStateKeywords
 * @property {Set<string>} levelOneAndTwoPseudoElements
 * @property {Set<string>} fontWeightKeywords
 * @property {Set<string>} levelThreePseudoElements
 * @property {Set<string>} vendorSpecificPseudoElements
 * @property {Set<string>} pseudoElements
 * @property {Set<string>} aNPlusBNotationPseudoClasses
 * @property {Set<string>} linguisticPseudoClasses
 * @property {Set<string>} atRulePagePseudoClasses
 * @property {Set<string>} otherPseudoClasses
 * @property {Set<string>} webkitProprietaryPseudoElements
 * @property {Set<string>} webkitProprietaryPseudoClasses
 * @property {Set<string>} pseudoClasses
 * @property {Set<string>} shorthandTimeProperties
 * @property {Set<string>} longhandTimeProperties
 * @property {Set<string>} timeProperties
 * @property {Set<string>} camelCaseKeywords
 * @property {Set<string>} counterIncrementKeywords
 * @property {Set<string>} counterResetKeywords
 * @property {Set<string>} gridRowKeywords
 * @property {Set<string>} nonStandardHtmlTags
 * @property {Set<string>} systemColors
 * @property {Set<string>} mediaFeatureNames
 * @property {Set<string>} deprecatedMediaFeatureNames
 * @property {Set<string>} atRules
 * @property {Set<string>} gridColumnKeywords
 * @property {Set<string>} gridAreaKeywords
 * @property {Set<string>} listStylePositionKeywords
 * @property {Set<string>} listStyleTypeKeywords
 * @property {Set<string>} listStyleImageKeywords
 * @property {Set<string>} listStyleShorthandKeywords
 * @property {Set<string>} fontStyleKeywords
 * @property {Set<string>} fontVariantKeywords
 * @property {Set<string>} fontStretchKeywords
 * @property {Set<string>} fontSizeKeywords
 * @property {Set<string>} lineHeightKeywords
 * @property {Set<string>} pageMarginAtRules
 * @property {Set<string>} fontShorthandKeywords
 * @property {Set<string>} keyframeSelectorKeywords
 */
