...
const logicalToPhysicalProperties = new Map([
	// Margin properties
...
/** @type {ReadonlyMap<string, string>} */
const physicalToLogicalProperties = new Map([
	// Margin properties
...
exports.logicalToPhysicalProperties = logicalToPhysicalProperties;
...
exports.physicalToLogicalProperties = physicalToLogicalProperties;
