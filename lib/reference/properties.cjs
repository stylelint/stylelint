...
const flowRelativeToPhysicalProperties = new Map([
	// Margin properties
...
/** @type {ReadonlyMap<string, string>} */
const physicalToFlowRelativeProperties = new Map([
	// Margin properties
...
exports.flowRelativeToPhysicalProperties = flowRelativeToPhysicalProperties;
...
exports.physicalToFlowRelativeProperties = physicalToFlowRelativeProperties;
