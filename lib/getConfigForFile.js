...
/** @typedef {Promise<{ config: StylelintConfig, filepath: string } | null>} ConfigPromise  */
...
module.exports = function(
	...
	if (optionsConfig !== undefined) {
		const cached /*: configPromise*/ = /** @type {ConfigPromise} */ (stylelint._specifiedConfigCache.get(
			optionsConfig,
		));
