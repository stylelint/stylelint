  ...
  help: `
    ...
    Options:
      ...
      --list-target-files
        ...
        List target files without parsing files.
...
module.exports = (argv /*: string[]*/) /*: Promise<void>|void*/ => {
  ...
  if (cli.flags.listTargetFiles) {
    optionsBase.listTargetFiles = cli.flags.listTargetFiles;
  }
    ...
    .then(options => {
      ...
      return standalone(options)
        .then(linted => {
          ...
          if (options.listTargetFiles) {
            linted.map(file => process.stdout.write(file + "\n"));
            return;
          }
