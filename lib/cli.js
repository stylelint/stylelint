 ...
 * @property {boolean} [disableDefaultIgnores]
 * @property {number} [maxWarnings]
 * @property {"scss" | "css" | "less" | "sugarss"} [syntax]
...
module.exports = (argv) => {
	...
	/** @type {CLIOptions} */
	const cli = meow(/** @type {import('meow').Options} */ (meowOptions));
	...
	if (cli.flags.syntax) {
		optionsBase.syntax = /** @type {"scss" | "css" | "sugarss" | "less"} */ (cli.flags.syntax);
	}
