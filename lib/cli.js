...
const meowOptions = {
    ...
    Options:
      ...
      --cache-strategy <${CACHE_STRATEGY_METADATA}|${CACHE_STRATEGY_CONTENT}>

        A strategy for the cache to use for detecting changed files. Defaults to "${DEFAULT_CACHE_STRATEGY}".

        The "${CACHE_STRATEGY_CONTENT}" strategy can be useful in cases where the modification time
      ...
      --formatter, -f <${getFormatterOptionsText('|')}>

        The output formatter. Defaults to "${DEFAULT_FORMATTER}".
