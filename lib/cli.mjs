...
const helpText = `
    ...
    Options:
      ...
      --[no-]safe-disables
        ...
        If disabled, while fixing Stylelint will respect the "stylelint-disable" comments for the
        rules that have been transitioned to use the "fix" util. For the remaining rules, it will
        ignore the "stylelint-disable" comments and match the unsafe autofixing prior to v13.2.0.

        This flag will remain set to true by default until all fixable core rules have been migrated.
...
export default async function main(argv) {
	...
	if (isBoolean(safeDisables)) {
		options.safeDisables = safeDisables;
	}
