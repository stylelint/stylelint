...
function lintPostcssResult(
  ...
  rules.forEach(ruleName => {
    ...
    const fileRuleSettings = postcssResult.stylelint.fileRules[ruleName] || [];

    const primaryOption = fileRuleSettings.length
      ? fileRuleSettings[0]
      : ruleSettings[0];
    const secondaryOptions = _.merge({}, ruleSettings[1], fileRuleSettings[1]);
