...
function lintPostcssResult(
  ...
  // The indentation is processed at the last.
  const indentationRuleIndex = rules.indexOf("indentation");
  if (indentationRuleIndex >= 0 && indentationRuleIndex !== rules.length - 1) {
    rules.splice(indentationRuleIndex, 1);
    rules.push("indentation");
  }
