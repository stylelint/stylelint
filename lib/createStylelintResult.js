...
module.exports = function(
	...
	if (postcssResult) {
		...
		const deprecations = deprecationMessages.map((deprecationMessage /*: messageType*/) => {
			return {
	...
	return stylelint.getConfigForFile(filePath).then((configForFile /*: configForFileType*/) => {
