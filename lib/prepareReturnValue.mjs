...
/** @typedef {import('stylelint').PostProcessorFunction} PostProcessorFunction */
 ...
 * @param {PostProcessorFunction} postProcessorFunction
 * @param {string} cwd
 *
...
export default function prepareReturnValue(
	...
	returnValue.results = postProcessorFunction(stylelintResults);
