...
module.exports = function(
  ...
  const disableGlobbing = options.disableGlobbing;
  ...
  if (!options.disableDefaultIgnores && !disableGlobbing) {
  ...
  let globPromise;
  if (disableGlobbing) {
    globPromise = Promise.resolve(fileList);
  } else {
    globPromise = globby(fileList, globbyOptions);
  }

  return globPromise.then(filePaths => {
