...
module.exports = function (results/*: Array<stylelint$result>*/)/*: stylelint$needlessDisablesReport*/ {
  ...
  results.forEach(result => {
    ...
    const rangeData/*: ?rangeDataType*/ = _.cloneDeep(result._postcssResult.stylelint.disabledRanges)
    ...
    Object.keys(rangeData).forEach(rule => {
      rangeData[rule].forEach((range/*: rangeType*/) => {
        ...
        const alreadyMarkedUnused/*: ?unusedRangeT*/ = unused.ranges.find((unusedRange/*: unusedRangeT*/) => {
