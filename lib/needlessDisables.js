...
module.exports = function(results) {
	...
	results.forEach((result) => {
		...
		/** @type {RangeDataType | undefined} */
		const rangeData = _.cloneDeep(
			result._postcssResult.stylelint.disabledRanges, //TODO TYPES correct _postcssResult type
		);
