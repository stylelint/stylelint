...
× 3 problems (3 errors, 0 warnings)`);
	...
	it('formats warnings with fixes', () => {
		const results = [
			{
				source: 'path/to/file.css',
				warnings: [
					{
						text: 'Expected "#FFF" to be "#FFFFFF"',
		...
		expect(output).toBe(stripIndent`
path/to/file.css
  1:12  ×  Expected "#FFF" to be "#FFFFFF" (fix: 14-15 -> "FFFF")  color-hex-length

× 1 problem (1 error, 0 warnings)
  1 error potentially fixable with the "--fix" option.`);
	});

	it('formats multiple warnings with fixes', () => {
		const results = [
			{
				source: 'path/to/file.css',
				warnings: [
					...
					{
						text: 'Expected "#000" to be "#000000"',
						rule: 'color-hex-length',
						severity: 'error',
						line: 1,
						column: 20,
...
path/to/file.css
  1:12  ×  Expected "#FFF" to be "#FFFFFF" (fix: 14-15 -> "FFFF")  color-hex-length
  1:20  ×  Expected "#000" to be "#000000" (fix: 22-23 -> "0000")  color-hex-length
