...
describe('unixFormatter', () => {
	...
	it('outputs warnings', () => {
		...
		expect(output).toBe(`path/to/file.css:1:1: Unexpected foo [error]
...
1 problem`);
	...
	it('output warnings with more than 80 characters and `process.stdout.columns` equal 90 characters', () => {
		...
		expect(output)
			.toBe(`path/to/file.css:1:1: Unexpected very very very very very very very very very very very very very long foo [error]
