...
const atRuleRegex = require('../../utils/atRuleRegex.cjs');
...
const rule = (primary, secondaryOptions) => {
	return (root, result) => {
		...
		root.walkAtRules(atRuleRegex.MEDIA_REGEX, (atRule) => check(atRule, atRule.params, nodeFieldIndices.atRuleParamIndex));
