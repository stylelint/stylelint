...
const testUrl = "somethingsomething somethingsomething";
...
testRule(rule, {
  ...
  accept: [
    ...
    {
      code:
        '@import "somethingsomethingsomethingsomething.css" screen, projection;'
    }
  ],
  ...
  reject: [
    ...
    {
      code:
        '@import url("somethingsomethingsomethingsomething.css") projection, screen;',
      message: messages.expected(30),
      line: 1,
      column: 75
    },
    {
      code:
        '@import "somethingsomethingsomethingsomething.css" screen, projection, tv;',
      message: messages.expected(30),
      line: 1,
      column: 74
    }
