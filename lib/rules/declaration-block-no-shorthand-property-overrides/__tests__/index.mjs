...
testRule({
	...
	reject: [
		...
		{
			code: 'a { padding-block: 5px; padding: 10px; }',
			message: messages.rejected('padding', 'padding-block'),
			line: 1,
			column: 25,
			endLine: 1,
			endColumn: 32,
		...
		{
			code: 'a { padding-inline-start: 5px; padding: 10px; }',
			message: messages.rejected('padding', 'padding-inline-start'),
			line: 1,
			column: 32,
			endLine: 1,
			endColumn: 39,
