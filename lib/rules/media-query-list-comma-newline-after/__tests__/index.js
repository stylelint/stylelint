...
testRule(rule, {
  ...
  accept: [
    ...
    {
      code:
        "@media screen and (color), /*comment1*/ /*comment2*/\nprojection and (color) {}"
    },
    {
      code: "@media screen and (color),/*comment*/\r\nprojection and (color) {}"
    },
    {
      code:
        "@media screen and (color), /*comment*/\r\nprojection and (color) {}"
    },
    {
      code:
        "@media screen and (color), /*comment1*/ /*com\r\nment2*/\r\nprojection and (color) {}"
    }
  ],
  ...
  reject: [
    ...
    {
      code:
        "@media screen and (color), /*comment1*/ /*comment2*/ projection and (color) {}",
      fixed:
        "@media screen and (color), /*comment1*/ /*comment2*/\n projection and (color) {}",
      message: messages.expectedAfter(),
      line: 1,
