...
testRule({
	...
	accept: [
		...
		{
			code: 'a { background-clip: text; }',
		},
		{
			code: 'a { background-clip: content-box; }',
		},
		{
		...
		{
			code: 'a { -webkit-background-clip: text; }',
	...
	reject: [
		...
		{
			code: 'a { -webkit-background-clip: content-box; }',
			fixed: 'a { background-clip: content-box; }',
			description: 'property with prefix-bound value depends on value',
			message: messages.rejected('-webkit-background-clip'),
			line: 1,
			column: 5,
			endLine: 1,
			endColumn: 28,
...
testRule({
	...
	config: [
		true,
		{ ignoreProperties: ['transform', 'columns', 'background-clip', '/^animation-/i'] },
	],
	fix: true,
