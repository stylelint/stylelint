...
testRule({
	ruleName,
	config: ['logical', { exceptProperties: ['/^margin/', 'width'] }],
...
testRule({
	ruleName,
	config: ['logical', { dir: 'rtl' }],

	accept: [
		{
			code: 'a { margin-inline-start: 10px; }',
			description: 'logical properties allowed in RTL context',
		},
		{
			code: 'a { padding-block-end: 5px; }',
			description: 'logical properties allowed in RTL context',
	...
	reject: [
		{
			...
			endLine: 1,
			endColumn: 24,
			description: 'logical properties flagged in LTR context (no autofix in physical mode)',
		},
	],
});
