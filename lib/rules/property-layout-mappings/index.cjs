	...
	return (root, result) => {
		...
		root.walkDecls((decl) => {
			...
			if (expectFlowRelative) {
				...
				const flowRelativeEquivalent = properties.physicalToFlowRelativeProperties.get(prop);
				...
				const physicalEquivalent = properties.flowRelativeToPhysicalProperties.get(prop);
