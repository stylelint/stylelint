...
testRule({
	...
	accept: [
		...
		{
			code: 'html { color: red; }',
			description: 'regular property inside html selector',
		},
		{
			code: '.parent .child { --custom-prop: red; }',
			description: 'custom property inside descendant selector',
		},
		{
			code: '#id { color: red; }',
			description: 'regular property inside id selector',
		},
		{
			code: 'div:hover { --custom-prop: red; }',
			description: 'custom property inside pseudo-class selector',
		},
		{
			code: 'div::before { color: red; }',
			description: 'regular property inside pseudo-element selector',
		},
		{
			code: '[data-attr] { --custom-prop: red; }',
			description: 'custom property inside attribute selector',
		},
		{
