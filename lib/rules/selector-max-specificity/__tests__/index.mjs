...
testRule({
	...
	reject: [
		...
		{
			code: '.foo { .bar {} }',
			message: messages.expectedResolved('.bar', '0,1,0', '.foo .bar'),
			line: 1,
			column: 8,
			endLine: 1,
			endColumn: 12,
		...
		{
			code: '#foo, .bar { & .baz {} }',
			message: messages.expectedResolved('& .baz', '0,1,0', ':is(#foo,.bar) .baz'),
			warnings: [
				{
					message: messages.expected('#foo', '0,1,0'),
					line: 1,
					column: 1,
					endLine: 1,
					endColumn: 5,
				...
				{
					message: messages.expectedResolved('& .baz', '0,1,0', ':is(#foo,.bar) .baz'),
					description: 'desugared to :is(#foo, .bar) .baz',
					line: 1,
					column: 14,
					endLine: 1,
					endColumn: 20,
...
testRule({
	...
	reject: [
		...
		{
			code: '.cd { .de { .fg {} } }',
			message: messages.expectedResolved('.fg', '0,2,1', ':is(.cd .de) .fg'),
			line: 1,
			column: 13,
			endLine: 1,
			endColumn: 16,
		...
		{
			code: '.cd { .de { &:hover > .fg {} } }',
			message: messages.expectedResolved('&:hover > .fg', '0,2,1', ':is(.cd .de):hover > .fg'),
			line: 1,
			column: 13,
			endLine: 1,
			endColumn: 26,
		...
		{
			code: '.cd { .de { .fg > & {} } }',
			message: messages.expectedResolved('.fg > &', '0,2,1', '.fg > :is(.cd .de)'),
			line: 1,
			column: 13,
			endLine: 1,
			endColumn: 20,
		...
		},
		{
			...
			message: messages.expectedResolved('.cd', '0,2,1', ':is(li + .ab,li .ef.ef) .cd'),
			line: 1,
			column: 39,
			endLine: 1,
			endColumn: 42,
	...
	reject: [
		{
			...
			message: messages.expectedResolved('#pop', '0,4,1', '.nested:is(.thing .thing2) #pop'),
			line: 1,
			column: 27,
			endLine: 1,
			endColumn: 31,
		},
		{
			...
			message: messages.expectedResolved('#here &', '0,4,1', '#here :is(.thing .thing2)'),
			line: 1,
			column: 17,
			endLine: 1,
			endColumn: 24,
		},
		{
			...
			message: messages.expectedResolved(
				'a.here &',
				'0,4,1',
				'a.here :is(.thing .thing2 .thing3 .thing4)',
			),
			line: 1,
			column: 33,
			endLine: 1,
		...
		},
		{
			...
			warnings: [
				{
					message: messages.expectedResolved('#b', '0,4,1', '.a #b'),
					line: 1,
					column: 6,
					endLine: 1,
					endColumn: 8,
				...
				{
					message: messages.expectedResolved('#c', '0,4,1', ':is(.a #b) #c'),
					line: 1,
					column: 11,
					endLine: 1,
					endColumn: 13,
...
testRule({
	...
	accept: [
		...
		{
			code: '#foo, .bar { a {}}',
			description: 'desugared to :is(#foo, .bar) a = (1,0,1)',
		},
	],
	...
	reject: [
		{
			code: '.bar { #foo, a {}} ',
			message: messages.expectedResolved('#foo', '1,0,1', '.bar #foo'),
			line: 1,
			column: 8,
			endLine: 1,
			endColumn: 12,
