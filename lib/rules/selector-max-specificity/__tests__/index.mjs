...
testRule({
	...
	reject: [
		...
		{
			code: '.foo { .bar {} }',
			message: messages.expected('.bar', '0,1,0', '.foo .bar'),
			line: 1,
			column: 8,
			endLine: 1,
			endColumn: 12,
		},
		{
			...
			warnings: [
				...
				{
					message: messages.expected('& .baz', '0,1,0', ':is(#foo,.bar) .baz'),
...
testRule({
	...
	reject: [
		...
		{
			code: '.cd { .de { .fg {} } }',
			message: messages.expected('.fg', '0,2,1', ':is(.cd .de) .fg'),
			line: 1,
			column: 13,
			endLine: 1,
			endColumn: 16,
		...
		{
			code: '.cd { .de { &:hover > .fg {} } }',
			message: messages.expected('&:hover > .fg', '0,2,1', ':is(.cd .de):hover > .fg'),
			line: 1,
			column: 13,
			endLine: 1,
			endColumn: 26,
		...
		{
			code: '.cd { .de { .fg > & {} } }',
			message: messages.expected('.fg > &', '0,2,1', '.fg > :is(.cd .de)'),
			line: 1,
			column: 13,
			endLine: 1,
			endColumn: 20,
		...
		},
		{
			...
			message: messages.expected('.cd', '0,2,1', ':is(li + .ab,li .ef.ef) .cd'),
			line: 1,
			column: 39,
			endLine: 1,
			endColumn: 42,
	...
	reject: [
		{
			...
			message: messages.expected('#pop', '0,4,1', '.nested:is(.thing .thing2) #pop'),
			line: 1,
			column: 27,
			endLine: 1,
			endColumn: 31,
		},
		{
			...
			message: messages.expected('#here &', '0,4,1', '#here :is(.thing .thing2)'),
			line: 1,
			column: 17,
			endLine: 1,
			endColumn: 24,
		},
		{
			...
			message: messages.expected('a.here &', '0,4,1', 'a.here :is(.thing .thing2 .thing3 .thing4)'),
			line: 1,
			column: 33,
			endLine: 1,
			endColumn: 41,
		},
		{
			...
			warnings: [
				{
					message: messages.expected('#b', '0,4,1', '.a #b'),
					line: 1,
					column: 6,
					endLine: 1,
					endColumn: 8,
				...
				{
					message: messages.expected('#c', '0,4,1', ':is(.a #b) #c'),
					line: 1,
					column: 11,
					endLine: 1,
					endColumn: 13,
...
testRule({
	...
	reject: [
		{
			code: '.bar { #foo, a {}} ',
			message: messages.expected('#foo', '1,0,1', '.bar #foo'),
			line: 1,
			column: 8,
			endLine: 1,
			endColumn: 12,
