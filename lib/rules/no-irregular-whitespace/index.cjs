...
const rule = (primary) => {
	return (root, result) => {
		...
		root.walkAtRules((atRule) => {
			...
			validate(atRule, cleanQuotedWhitespace(getAtRuleParams(atRule)), nodeFieldIndices.atRuleParamIndex);
		...
		root.walkDecls((decl) => {
			...
			validate(decl, cleanQuotedWhitespace(getDeclarationValue(decl)), nodeFieldIndices.declarationValueIndex);
		});
	};
};
