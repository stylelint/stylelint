...
const rule = (primary) => {
	return (root, result) => {
		...
		root.walkAtRules((atRule) => {
			...
			validate(atRule, getAtRuleParams(atRule), nodeFieldIndices.atRuleParamIndex, normalizeQuotedInValue);
		...
		root.walkDecls((decl) => {
			...
			validate(decl, decl.raws.between, nodeFieldIndices.declarationBetweenIndex, normalizeQuotedInValue);
			validate(decl, getDeclarationValue(decl), nodeFieldIndices.declarationValueIndex, normalizeQuotedInValue);
		});
	};
};
