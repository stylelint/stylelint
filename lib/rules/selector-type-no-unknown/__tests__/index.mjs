...
testRule({
	...
	accept: [
		...
		{
			code: 'fencedframe, listbox, model, portal, selectlist, geolocation, usermedia, install {}',
		...
		{
			code: 'feDropShadow {}',
			description: 'svg tags added in SVG 2',
		},
		{
			code: 'animateColor, color-profile {}',
			description: 'obsolete svg tags',
		},
		{
