...
const rule = (primary, secondaryOptions) => {
	return (root, result) => {
		...
		root.walkAtRules(/^media$/i, (atRule) => {
			...
			parseFromTokens(tokenizeWithDimensionsInsteadOfPercentages(params)).forEach((mediaQuery) => {
		...
		root.walkDecls((decl) => {
			...
			parseListOfComponentValues(tokenizeWithDimensionsInsteadOfPercentages(value)).forEach(
				(componentValue) => {
 ...
 */
function tokenizeWithDimensionsInsteadOfPercentages(value) {
