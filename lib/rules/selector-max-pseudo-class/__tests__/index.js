...
testRule(rule, {
  ...
  accept: [
    ...
    {
      code: ".foo .bar:first-child { color: pink; }",
...
testRule(rule, {
  ...
  reject: [
    {
      code: "input:first-of-type:read-only:hover { color: pink; }",
