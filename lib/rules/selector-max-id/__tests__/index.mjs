...
testRule({
	...
	reject: [
		...
		{
			code: '#foo #bar :global(#bazz) #fizz {}',
			description: 'scope selector: greater than max ID selectors',
			warnings: [
				{
					message: messages.expected('#foo #bar :global(#bazz) #fizz', 2),
					line: 1,
					column: 1,
					endLine: 1,
					endColumn: 31,
...
// with includeContextFunctionalPseudoClasses optional params
...
testRule({
	...
	config: [
		2,
		{
			...
			includeContextFunctionalPseudoClasses: [':not', /^:(glob|loc)al/, ':webkit-any'],
		},
	],
	...
	accept: [
		...
		{
			code: ':-webkit-any(#foo #bar) {}',
		},
		{
			code: '#foo :global(#bazz #fizz) :local(#bar) {}',
		},
	],

	reject: [
		{
			code: ':webkit-any(#foo #bar #baz) {}',
			description: 'scope selector: greater than max ID selectors',
			message: messages.expected('#foo #bar #baz', 2),
			line: 1,
			column: 13,
		...
		{
			code: 'a:not(#foo #bar #bazz) {}',
			message: messages.expected('#foo #bar #bazz', 2),
			line: 1,
			column: 7,
			endLine: 1,
			endColumn: 22,
