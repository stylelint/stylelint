...
testRule(rule, {
  ...
  accept: [
    ...
    {
      code: "#foo { @media print { #bar {} } }",
      description: "compound selector: nested @ statement"
    },
    {
      code: "#foo { @if ($p == 1) { #bar {} } }",
      description:
        "compound selector: greater than max id selectors, nested @ statement"
    },
    {
      code: ".foo { @if ($p == 1) { #bar #baz {} } }",
      description: "compound selector in nested @ statement"
    },
    {
