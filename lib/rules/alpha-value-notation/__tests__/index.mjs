...
testRule({
	...
	reject: [
		...
		},
		{
			...
			fixed: 'a { color: rgba(0, 0, 0, 0.5); background-color: rgba(0, 0, 0, 0.7); }',
			warnings: [
				{
					message: messages.expected('50%', '0.5'),
					line: 1,
...
testRule({
	...
	reject: [
		...
		},
		{
			...
			fixed: 'a { color: rgba(0, 0, 0, 50%); background-color: rgba(0, 0, 0, 70%); }',
			warnings: [
				{
					message: messages.expected('0.5', '50%'),
					line: 1,
...
testRule({
	...
	reject: [
		...
		{
			code: 'a { opacity: 10%; shape-image-threshold: 50%; }',
			warnings: [
				{
					message: messages.expected('10%', '0.1'),
					line: 1,
		...
		{
			code: '@keyframes name { color: rgba(0, 0, 0, 45%); }',
			message: messages.expected('45%', '0.45'),
			line: 1,
			column: 40,
			endLine: 1,
			endColumn: 43,
...
// Percentage with computeEditInfo
testRule({
	ruleName,
	config: ['percentage'],
	computeEditInfo: true,
	...
	reject: [
		...
		{
			code: 'a { opacity: 0.1; shape-image-threshold: 0.5; }',
			warnings: [
				{
					message: messages.expected('0.1', '10%'),
					line: 1,
