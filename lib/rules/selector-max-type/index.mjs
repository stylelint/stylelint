...
import getSelectorMeaningfulSource from '../../utils/getSelectorMeaningfulSource.mjs';
...
const rule = (primary, secondaryOptions) => {
	return (root, result) => {
		...
		function checkSelector(resolvedSelectorNode, selectorNode, ruleNode) {
			...
			if (count > primary) {
				const { selectorStr, index, endIndex } = getSelectorMeaningfulSource(selectorNode);
