	...
	accept: [
		...
		},
		{
			code: stripIndent`
				...
				a, /* stylelint-disable-next-line selector-max-type */
				b,
				/* stylelint-disable-next-line selector-max-type */
				c
				{}
...
testRule({
	...
	reject: [
		...
		},
		{
			...
			message: messages.expected('foo bar:not(baz)', 2),
			line: 1,
			column: 1,
			endLine: 1,
			endColumn: 17,
...
testRule({
	...
	reject: [
		...
		{
			code: 'div { foo-@{n} { content: ""; } }',
			description: 'non-standard child rule less',
			message: messages.expected('div', 0),
			line: 1,
			column: 1,
			endLine: 1,
