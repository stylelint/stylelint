...
testRule({
	...
	accept: [
		{
			code: 'let Component = styled.a`transform: translate(1, 1);`;',
		},
	],

	reject: [
		{
			code: 'let Component = styled.a`transform: translate(1, 1)scale(3)`;',
			fixed: 'let Component = styled.a`transform: translate(1, 1) scale(3)`;',
			message: messages.expected,
			line: 1,
			column: 52,
		},
