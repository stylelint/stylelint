...
testRule({
	...
	accept: [
		...
		{
			code: '@media (min-width: theme(screens.md) && fooFunction(300px)) {}',
		},
		{
	...
	reject: [
		...
		},
		{
			...
			message: messages.rejected('(min-width: theme(screens.md) and var(300px))'),
			line: 1,
			column: 8,
			endLine: 1,
			endColumn: 53,
		},
		{
			...
			message: messages.rejected('(min-width: var(300px) or theme(screens.md))'),
			line: 1,
			column: 8,
			endLine: 1,
			endColumn: 52,
