...
testRule({
	...
	accept: [
		...
		{
			code: '.u-m\\00002b {}',
			description: 'single escaped selector (hex escape)',
		},
		{
			code: '.u-m\\+ {}',
			description: 'single escaped selector (character escape)',
		},
		{
			code: 'a {}\n@media print { a {} }',
	...
	reject: [
		{
			code: '.u-m\\00002b {} .u-m\\+ {}',
			description: 'duplicate selectors with different escape formats (hex vs character)',
			warnings: [
				{
					message: messages.rejected('.u-m\\+', 1),
					line: 1,
					column: 16,
					endLine: 1,
					endColumn: 22,
		...
		{
			code: '.u-m\\2b {} .u-m\\00002b {}',
			description: 'duplicate selectors with short vs long hex escape',
			warnings: [
				{
					message: messages.rejected('.u-m\\00002b', 1),
					line: 1,
					column: 12,
					endLine: 1,
					endColumn: 23,
		...
		{
			code: ':is(a, b) c {} a, b { & c {} }',
			description: 'duplicate caused by nesting with &-parent selector and :is()',
			message: messages.rejected('& c', 1),
			line: 1,
			column: 23,
			endLine: 1,
			endColumn: 26,
		...
		},
		{
			...
			message: messages.rejected('.bar.foo', 1),
			line: 1,
			column: 13,
			endLine: 1,
			endColumn: 21,
		...
		{
			code: '.foo > .baz.bar {} .foo > .bar.baz {}',
			message: messages.rejected('.foo > .bar.baz', 1),
			line: 1,
			column: 20,
			endLine: 1,
			endColumn: 35,
		...
		{
			code: 'a:hover:focus {} a:focus:hover {}',
			message: messages.rejected('a:focus:hover', 1),
			line: 1,
			column: 18,
			endLine: 1,
			endColumn: 31,
