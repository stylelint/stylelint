 ...
 * @param {Document|null} document the document node with `postcss-html` and `postcss-styled`.
...
function isEofNode(document, root) {
  ...
  // In the `postcss-html` and `postcss-styled` syntax, checks that there is text after the given node.
  let after;
