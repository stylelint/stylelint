...
testRule(rule, {
  ...
  accept: [ {
    code: "\n\n\n// one\n\n\n",
    description: "Three empty lines at beginning and end of single line comment (max: 3)",
  }, {
    code: "// one\n\n\n\n// two",
    description: "Three empty lines between single line comments (max: 3)",
  } ],
  ...
  reject: [ {
    ...
    line: 4,
    column: 1,
    description: "Four empty lines at beginning of single line comment (max: 3)",
  }, {
    code: "// one\n\n\n\n",
    message: messages.expected(3),
    line: 5,
    column: 1,
    description: "Four empty lines at end of single line comment (max: 3)",
  }, {
    code: "// one\n\n\n\n\n// two",
    message: messages.expected(3),
    line: 5,
    column: 1,
    description: "Four empty lines between single line comments (max: 3)",
  } ],
})
