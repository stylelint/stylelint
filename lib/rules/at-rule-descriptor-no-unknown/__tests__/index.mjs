...
testRule({
	...
	accept: [
		{
			code: '@counter-style foo { system: cyclic; symbols: url(gold-medal.svg); suffix: " "; }',
		},
		{
		...
		// },
		// {
		// 	code: '@container (width > 400px) and (height > 400px) { a { width: 50%; } }',
		// },
		// {
		// 	code: '@container not (width > 400px) { a { width: 50%; } }',
		// },
		// {
		// 	code: '@container summary (min-width > 400px) { @container (min-width: 800px) { a { width: 50%; } } }',
		// },
	],
