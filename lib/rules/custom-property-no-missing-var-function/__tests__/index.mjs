...
testRule({
	...
	accept: [
		...
		},
		{
			...
			description: 'ignore a shorthand property that can receive a dashed-ident',
		},
		{
			code: '@property --foo {} a { top: anchor(--foo bottom); }',
			description: 'ignore the anchor name in anchor() without a fallback',
		},
	],
	...
	reject: [
		...
		},
		{
			...
			endColumn: 59,
			description:
				'custom property in the anchor() fallback missing var() syntax, declared anchor name ignored',
		},
		{
			...
			endColumn: 65,
			description:
				'custom property in the anchor-size() fallback missing var() syntax, declared anchor name ignored',
		},
		{
