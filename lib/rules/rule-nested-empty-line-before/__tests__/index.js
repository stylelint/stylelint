...
it("deprecation warning", () => {
  ...
  return stylelint({ code, config }).then(output => {
    ...
    expect(result.deprecations[0].text).toEqual(`\'${ruleName}\' has been deprecated and in 8.0 will be removed. Instead use \'rule-empty-line-before\'.`)
...
testRule(rule, {
  ...
  accept: [ {
    ...
    description: "no empty line after another nested rule",
  }, {
    code: `a {
      color: pink;
    ...
    description: "shared-line comment skipped",
  }, {
    code: `a {
      color: pink;

      b { color: red; }
      /* comment */ c { color: blue; }
    }`,
    description: "shared-line comment skipped",
  }, {
    code: "a {\n $var: pink; \n\n b {color: red; } \n c {color: blue; }\n}",
...
testRule(rule, {
  ...
  reject: [ {
    ...
    code: "@media {\n\n  a{} /* comment */\n  b {}\n\n}",
    message: messages.expected,
    description: "inline comment does not save you",
  }, {
    code: "@media {\r\n\r\n  a{}\r\n  b {}\r\n\r\n}",
    description: "CRLF",
    message: messages.expected,
...
testRule(rule, {
  ...
  accept: [ {
    ...
    description: "empty line before nested rule following nested rule",
  }, {
    code: `a {
      color: pink;
      b {color: red; } /* comment */
    ...
    description: "comment between nested rules, no empty lines",
  }, {
    code: "a {\n $var: pink; \n b {color: red; } \n\n c {color: blue; }\n}",
    description: "scss variable",
  }, {
  ...
  reject: [ {
    ...
    description: "no shared-line comment before",
    message: messages.expected,
    line: 5,
    column: 20,
  } ],
