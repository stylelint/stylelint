...
testRule({
	...
	accept: [
		...
		{
			code: 'a { width: 1em; height: 1px*@Height }',
			description: 'ignore Less variable',
		},
		{
			code: 'a { width: 1em; height: @Height }',
			description: 'ignore Less variable',
		},
		{
			code: 'a { height: .averAge(16px, 50px); #b(1PX);}',
	...
	reject: [
		...
		{
			code: '@variable: 10Px*@Height',
			fixed: '@variable: 10px*@Height',
			message: messages.expected('10Px*@Height', '10px*@Height'),
			line: 1,
			column: 17,
			warnings: [
				{
		...
		{
			code: '@variable: @Height*10pX',
			fixed: '@variable: @Height*10px',
			message: messages.expected('@Height*10pX', '@Height*10px'),
			line: 1,
			column: 25,
			warnings: [
				{
		...
		{
			code: '@variable: .averAge(16Px, 50pX)',
			fixed: '@variable: .averAge(16px, 50px)',
			message: messages.expected('.averAge(16Px, 50pX)', '.averAge(16px, 50px)'),
			line: 2,
			column: 21,
			warnings: [
				{
...
testRule({
	...
	reject: [
		...
		{
			code: '@variable: @Height*(10px + 100%)',
			fixed: '@variable: @Height*(10PX + 100%)',
			message: messages.expected('@Height*(10px + 100%)', '@Height*(10PX + 100%)'),
			line: 1,
			column: 21,
			warnings: [
				{
		...
		{
			code: '@variable: 10px + #b(2Px)',
			fixed: '@variable: 10PX + #b(2PX)',
			message: messages.expected('px', 'PX'),
			line: 2,
			column: 12,
			warnings: [
