...
testRule(rule, {
  ...
  accept: [
    ...
    {
      code:
        "@media screen { color: green; @media (min-width: 768px) { color: red; } }"
    },
    {
    ...
    {
      code:
        "a { animation: 3s ease-in 1s 2 reverse both paused animation-name; }"
    },
    {
      code:
        "a { animation: 3s ease-in 1s 2 reverse both paused aNiMaTiOn-NaMe; }"
  ...
  reject: [
    ...
    {
      code: "a { display: block !Important; }",
      fixed: "a { display: block !important; }",
      message: messages.expected("!Import", "!important"),
      line: 1,
      column: 20
    },
    {
    ...
    {
      code:
        "a { list-style: custom-counter-style url('../img/dino.png') OUTSIDE; }",
      fixed:
        "a { list-style: custom-counter-style url('../img/dino.png') outside; }",
  ...
  reject: [
    {
      ...
      column: 14,
      description:
        "Rejected because doesn't match exact case-sensitive string that is ignored"
    },
    {
      code: "a { display: BLOCK; }",
      fixed: "a { display: block; }",
...
testRule(rule, {
  ...
  config: [
    "upper",
    { ignoreKeywords: ["Block", "bLoCk", "block", "/^(f|F)lex$/"] }
  ],
  fix: true,
