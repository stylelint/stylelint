  ...
  return (root, result) => {
    ...
    root.walkDecls(decl => {
      ...
      valueParser(value).walk(node => {
        ...
        // Ignore keywords within `url`, `var` and `counter(s)` functions
        if (node.type === "function" && (valueLowerCase === "url" || valueLowerCase === "var" || valueLowerCase === "counter" || valueLowerCase === "counters")) {
          return false
        }
