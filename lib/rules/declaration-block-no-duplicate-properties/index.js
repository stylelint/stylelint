...
const containsUnsupportedFunction = require('../../utils/containsUnsupportedFunction');
...
const isEqualValueSyntaxes = (value1, value2) => {
	...
	try {
		...
		// css-tree will throw an exception if !isStandardSyntaxValue(value)
	...
	if (containsUnsupportedFunction(value1Node) || containsUnsupportedFunction(value2Node)) {
		return false;
	}
