...
const isEqualValueNodes = (nodes1, nodes2, property) => {
	...
	for (let i = 0; i < nodes1.length; i++) {
		...
		// Named colors have the same syntax even if the names differ, but only for single-value color properties
		if (
			node1.type === 'Identifier' &&
			node2.type === 'Identifier' &&
			singleValueColorProperties.has(property.toLowerCase()) &&
