...
testRule(rule, {
  ...
  accept: [
    ...
    {
      code:
        "@keyframes foo {} a { animation: var(--custom-property) 2s linear; }",
    ...
    {
      code:
        "@keyframes foo {} a { animation: foo 100ms cubic-bezier(0.1, 0.7, 1.0, 0.1); }",
    ...
    {
      code:
        "@keyframes foo {} @keyframes bar {} a { animation-name: foo, bar; }",
