...
testRule({
	...
	accept: [
		...
		{
			code: "@import url('../file.jpg');",
		},
		{
			code: '@import url("../file.jpg");',
		},
		{
			code: "@import url('/path/to/file.jpg');",
		},
		{
			code: "@import url('https://www.google.com/file.jpg');",
		},
		{
			code: "@import url('http://www.google.com/file.jpg');",
		},
	],
	...
	reject: [
		...
		{
			code: "@import url('//www.google.com/file.jpg')",
			message: messages.rejected,
			line: 1,
			column: 5,
			endLine: 1,
		...
		{
			code: `@import url("//www.google.com/file.jpg") screen and (min-width: 768px);`,
			message: messages.rejected,
			line: 1,
			column: 5,
			endLine: 1,
