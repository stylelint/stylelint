...
testRule({
	...
	accept: [
		...
		{
			code: "@import url('../foo.scss');",
		},
		{
			code: '@import url("../foo.scss");',
		},
		{
			code: "@import url('/path/to/foo.scss');",
		},
		{
			code: "@import url('https://www.google.com/foo.scss');",
		},
		{
			code: "@import url('http://www.google.com/foo.scss');",
		},
	],
	...
	reject: [
		...
		{
			code: "@import url('//www.google.com/foo.scss')",
			message: messages.rejected,
			line: 1,
			column: 13,
			endLine: 1,
		...
		{
			code: `@import url("//www.google.com/foo.scss") screen and (min-width: 768px);`,
			message: messages.rejected,
			line: 1,
			column: 13,
			endLine: 1,
