...
const { acceptCustomIdentsProperties } = require('../../reference/properties.cjs');
const report = require('../../utils/report.cjs');
const ruleMessages = require('../../utils/ruleMessages.cjs');
const validateOptions = require('../../utils/validateOptions.cjs');
const valueParser = require('postcss-value-parser');
const { isRegExp, isString } = require('../../utils/validateTypes.cjs');
const { colord } = require('./colordUtils.cjs');
...
const { namedColorsKeywords } = require('../../reference/keywords.cjs');
