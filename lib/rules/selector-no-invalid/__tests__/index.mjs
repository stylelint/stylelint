...
testRule({
	...
	reject: [
		...
		{
			code: '.foo:has(::before) {}',
			message: messages.rejected(':has(::before)', 'pseudo-elements are invalid within ":has()"'),
			line: 1,
			column: 5,
			endLine: 1,
			endColumn: 19,
		...
		},
		{
			...
			message: messages.rejected(':has(.baz)', '":has()" is invalid within ":has()"'),
			line: 1,
			column: 14,
			endLine: 1,
			endColumn: 24,
		...
		{
			code: 'a::after .foo {}',
			message: messages.rejected('::after .foo', 'combinators are invalid after "::after"'),
			line: 1,
			column: 2,
			endLine: 1,
			endColumn: 14,
