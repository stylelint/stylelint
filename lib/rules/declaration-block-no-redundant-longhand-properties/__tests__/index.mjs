...
testRule({
	...
	accept: [
		...
		{
			code: 'a { margin: 10px; margin-left: 20px; }',
			description: 'shorthand then longhand with different values (not redundant)',
		},
		{
			code: 'a { padding: 5px; padding-top: 10px; }',
			description: 'shorthand then longhand with different values (not redundant)',
		},
	],
	...
	reject: [
		...
		},
		{
			...
			message: messages.redundantLonghand('background-color', 'background'),
			line: 1,
			column: 22,
			endLine: 1,
			endColumn: 38,
		...
		},
		{
			...
			fixed: 'a { margin: 10px; }',
			description: 'shorthand then longhand with same value (redundant)',
			message: messages.redundantLonghand('margin-left', 'margin'),
			line: 1,
			column: 19,
			endLine: 1,
			endColumn: 30,
		...
		},
		{
			...
			fixed: 'a { padding: 5px; }',
			description: 'shorthand then longhand with same value (redundant)',
			message: messages.redundantLonghand('padding-top', 'padding'),
			line: 1,
			column: 19,
			endLine: 1,
			endColumn: 30,
