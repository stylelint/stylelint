...
testRule({
	...
	accept: [
		...
		{
			code: 'a { transition-behavior: discrete; transition-delay: 500ms; transition-duration: 250ms; transition-timing-function: ease-in-out; transition-property: transform; }',
			description: "transition-behavior isn't widely supported yet",
		},
		{
	...
	reject: [
		...
		{
			code: 'a { transition-delay: 500ms; transition-duration: 250ms; transition-timing-function: ease-in-out; transition-property: transform; transition-behavior: discrete;  }',
			fixed: 'a { transition: transform 250ms ease-in-out 500ms; transition-behavior: discrete;  }',
			description: "transition-behavior isn't widely supported yet",
			message: messages.expected('transition'),
		},
		{
