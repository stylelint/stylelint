...
testRule({
	...
	accept: [
		...
		{
			code: 'a { background: red; background-color: blue; }',
			description: 'shorthand then longhand with different values (not redundant)',
		},
	],
	...
	reject: [
		...
		{
			code: 'a { background: red; background-color: red; }',
			fixed: 'a { background: red; }',
			description: 'shorthand then longhand with same value (redundant)',
			message: messages.unexpectedLonghand('background-color', 'background'),
			line: 1,
			column: 22,
			endLine: 1,
			endColumn: 38,
		...
		{
			code: 'a { background-image: url(x); background-position: 0 0; background-size: contain; background-repeat: repeat; background-origin: padding-box; background-clip: border-box; background-attachment: scroll; background-color: transparent; }',
			unfixable: true,
			description:
				'background with background-size present cannot be safely combined (size requires a slash after position)',
			message: messages.expected('background'),
		},
		{
			code: 'a { background-image: url(a), url(b); background-position: 0 0, 5px 5px; background-size: cover, contain; background-repeat: no-repeat, repeat; background-origin: border-box, padding-box; background-clip: text, border-box; background-attachment: fixed, scroll; background-color: red; }',
			unfixable: true,
			description: 'multi-layer background with background-size present is not combined',
			message: messages.expected('background'),
		},
		{
			code: 'a { margin: 1px; margin-left: 1px; margin-right: 1px; }',
			fixed: 'a { margin: 1px; }',
			description: 'shorthand then multiple longhands with same value',
			warnings: [
				{
					message: messages.unexpectedLonghand('margin-left', 'margin'),
					line: 1,
					column: 18,
					endLine: 1,
					endColumn: 29,
				...
				{
					message: messages.unexpectedLonghand('margin-right', 'margin'),
					line: 1,
					column: 36,
					endLine: 1,
					endColumn: 48,
		...
		{
			code: 'a { margin: 1px; margin-left: 2px; margin-right: 1px; }',
			fixed: 'a { margin: 1px; margin-left: 2px; }',
			description: 'shorthand then one longhand with same value',
			message: messages.unexpectedLonghand('margin-right', 'margin'),
			line: 1,
			column: 36,
			endLine: 1,
...
testRule({
	...
	accept: [
		{
			code: 'a { text-decoration: underline 1px; text-decoration-thickness: 1px; }',
			description: 'shorthand then longhand with same value (ignored longhand)',
		},
	],
...
testRule({
	...
	accept: [
		...
		{
			code: 'a { padding: 5px; padding-top: 5px; }',
			description: 'shorthand then longhand with same value (ignored shorthand)',
		},
	],
