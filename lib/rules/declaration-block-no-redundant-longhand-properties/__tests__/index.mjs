...
testRule({
	...
	reject: [
		...
		{
			code: 'a { margin-inline-start: 1px; padding-block-start: 1rem; margin-inline-end: 2px; padding-block-end: 2rem; }',
			warnings: [
				{
					message: messages.expected('margin-inline'),
					line: 1,
					...
					fix: {
						...
						text: ': 1px 2px; padding-block-start: 1rem',
					},
				},
				{
					message: messages.expected('padding-block'),
		...
		{
			code: 'a { margin-inline-start: 1px; padding-block-start: 1rem; margin-inline-end: 2px; top: 10px; padding-block-end: 2rem; right: 20px; bottom: 30px; left: 40px; }',
			warnings: [
				{
					message: messages.expected('margin-inline'),
					line: 1,
