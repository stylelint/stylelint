...
testRule({
	...
	reject: [
		...
		},
		{
			...
			endLine: 1,
			endColumn: 25,
			description: 'Includes comment between selectors.',
		},
		{
			code: 'a, span, /* comment */ div {}',
			message: messages.rejected,
			line: 1,
			column: 28,
			endLine: 1,
		...
		{
			code: 'a, /* comment */ span, /* comment */ div {}',
			message: messages.rejected,
			line: 1,
			column: 42,
			endLine: 1,
		...
		{
			code: '@media print /* comment */, screen {}',
			message: messages.rejected,
			line: 1,
			column: 36,
			endLine: 1,
			endColumn: 38,
			description: 'Includes comment between selectors (at-rule).',
		},
		{
