...
const isFirstNestedStatement = require("../utils/isFirstNestedStatement")
...
module.exports = function (opts/*: {
  ...
  if (optionsMatches(opts.options, "ignore", "after-comment") && isAfterCommentLine(opts.rule)) {
    return
  }
  ...
  if (optionsMatches(opts.options, "except", "first-nested") && isFirstNestedStatement(opts.rule)) {
