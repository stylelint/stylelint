...
testRule({
	...
	accept: [
		...
		{
			code: 'a { display: contents; }',
			description: 'ignores values that are neither short or full',
		},
		{
...
testRule({
	...
	reject: [
		...
		{
			code: 'a { display: /* comment 1 */block/* comment 2 */; }',
			fixed: 'a { display: /* comment 1 */block flow/* comment 2 */; }',
			message: messages.expected('block', 'block flow'),
			line: 1,
			column: 29,
			endLine: 1,
			endColumn: 34,
			fix: { range: [32, 33], text: 'k flow' },
		},
	],
});
