...
testRule(rule, {
  ...
  accept: [
    ...
    {
      code:
        "@media (min-width: 700px) /* comments */ and (orientation: landscape) {}"
    },
    {
      code:
        "@media /* comments */ (min-width: 700px) and (orientation: landscape) {}"
    },
    {
...
testRule(rule, {
  ...
  reject: [
    ...
    {
      code:
        "@media @smartphones /* comments */ and (ORIENTATION: landscape) {}",
      fixed:
        "@media @smartphones /* comments */ and (orientation: landscape) {}",
      message: messages.expected("ORIENTATION", "orientation"),
      line: 1,
...
testRule(rule, {
  ...
  reject: [
    ...
    {
      code:
        "@media (MIN-WIDTH: ($var + 10px)) and /* comments */ (#{$MONOCHROME}) { }",
      fixed:
        "@media (min-width: ($var + 10px)) and /* comments */ (#{$MONOCHROME}) { }",
      message: messages.expected("MIN-WIDTH", "min-width"),
      line: 1,
...
testRule(rule, {
  ...
  accept: [
    ...
    {
      code:
        "@media (MIN-WIDTH: 700px), PRINT and /* comments */ (ORIENTATION: landscape) { }"
    },
    {
      code:
        "@media (MIN-WIDTH: 700px), /* comments */ PRINT and (ORIENTATION: landscape) { }"
    },
    {
      code: "@media (-WEBKIT-MIN-DEVICE-PIXEL-RATION: 2) { }"
    },
...
testRule(rule, {
  ...
  reject: [
    ...
    {
      code:
        "@media (MIN-WIDTH: ($var + 10px)) and /* comments */ (orientation: landscape){ }",
      fixed:
        "@media (MIN-WIDTH: ($var + 10px)) and /* comments */ (ORIENTATION: landscape){ }",
      message: messages.expected("orientation", "ORIENTATION"),
      line: 1,
