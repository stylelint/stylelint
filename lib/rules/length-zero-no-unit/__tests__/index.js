...
testRule({
	...
	accept: [
		...
		},
		{
			code: 'a { flEx: 0px; }',
			description:
				'do not fail if zero is the last value in flex shorthand declaration with 1 value',
		},
		{
			code: 'a { flEx: 1 0px; }',
			description:
				'do not fail if zero is the last value in flex shorthand declaration with 2 values',
		},
	],
	...
	reject: [
		...
		},
		{
			...
			description: 'zero flex basis as third f',
			message: messages.rejected,
			line: 1,
			column: 16,
		},
