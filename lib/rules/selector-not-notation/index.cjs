...
const fix = require('../../utils/fix.cjs');
	...
	return (root, result) => {
		...
		root.walkRules((ruleNode) => {
			...
			const fixSimple = (not) => {
				...
				return getNewRange(not, ruleNode);
			};
 ...
 * @param {Pseudo} pseudo
 * @param {RuleNode} ruleNode
 * @returns {ReturnType<FixerData['callback']>}
 */
function getNewRange(pseudo, ruleNode) {
