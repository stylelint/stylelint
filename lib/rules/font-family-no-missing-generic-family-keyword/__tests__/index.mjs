...
testRule({
	...
	accept: [
		...
		{
			code: 'a { font-family: "Apple Color Emoji", emoji, sans-serif; }',
		},
		{
			code: 'a { font-family: "Latin Modern Math", math, serif; }',
		},
		{
			code: 'a { font-family: "Noto Sans", fangsong, serif; }',
		},
		{
