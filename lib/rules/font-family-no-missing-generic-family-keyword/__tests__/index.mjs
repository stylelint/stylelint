...
testRule({
	...
	accept: [
		...
		{
			code: 'a { font-family: "Apple Color Emoji", emoji; }',
		},
		{
			code: 'a { font-family: "Latin Modern Math", math; }',
		},
		{
			code: 'a { font-family: "Noto Serif", fangsong; }',
		},
		{
			code: 'a { font-family: emoji; }',
		},
		{
			code: 'a { font-family: math; }',
		},
		{
			code: 'a { font-family: fangsong; }',
		},
		{
			code: 'a { font: normal 1em oblique emoji; }',
		},
		{
			code: 'a { font: 16px medium math; }',
		},
		{
			code: 'a { font: italic small-caps bold 12px fangsong; }',
		},
		{
			code: 'a { font: math math; }',
		},
		{
			code: 'a { font: math / normal math; }',
		},
		{
	...
	reject: [
		...
		{
			code: 'a { font-family: "Apple Color Emoji"; }',
			message: messages.rejected,
			line: 1,
			column: 18,
			endLine: 1,
		...
		{
			code: 'a { font-family: "Cambria Math"; }',
			message: messages.rejected,
			line: 1,
			column: 18,
			endLine: 1,
		...
		{
			code: 'a { font: italic 16px "SomeFont"; }',
			message: messages.rejected,
			line: 1,
			column: 23,
			endLine: 1,
