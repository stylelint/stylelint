...
This rule considers custom media queries defined within the same source or within the files specified in the [`semantics`](../../../docs/user-guide/configure.md#semantics) configuration property to be known.
