	...
	reject: [
		{
			...
			message: messages.rejected('/^TODO:/'),
			line: 1,
			column: 1, // should be `4`, see: https://github.com/shellscape/postcss-less/issues/178
			endLine: 1,
			endColumn: 9,
		},
		{
		...
		},
		{
			...
			column: 1, // should be `4`, see: https://github.com/shellscape/postcss-less/issues/178
			endLine: 1,
			endColumn: 5, // should be `12`, see: https://github.com/shellscape/postcss-less/issues/178
		},
	],
});
