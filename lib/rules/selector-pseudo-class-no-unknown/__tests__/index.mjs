...
testRule({
	...
	accept: [
		...
		{
			code: 'meter:low-value { color: red; }',
		},
		{
			code: stripIndent`
				/* stylelint-disable-next-line selector-pseudo-class-no-unknown */
				:unknown, /* stylelint-disable-next-line selector-pseudo-class-no-unknown */
				:unknown,
				/* stylelint-disable-next-line selector-pseudo-class-no-unknown */
				:unknown
				{}
		...
		},
		{
			code: stripIndent`
				/* stylelint-disable-next-line selector-pseudo-class-no-unknown */
				@page :unknown, /* stylelint-disable-next-line selector-pseudo-class-no-unknown */
				@page :unknown,
				/* stylelint-disable-next-line selector-pseudo-class-no-unknown */
				@page :unknown
				{}
