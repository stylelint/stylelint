import { atRuleRegexes, maybeHasRegexes } from '../../utils/regexes.mjs';
...
const rule = (primary) => {
	return (root, result) => {
		...
		root.walkRules(maybeHasRegexes.pseudo, (ruleNode) => {
		...
		root.walkAtRules(atRuleRegexes.pageName, (atRuleNode) => {
			if (!maybeHasRegexes.pseudo.test(atRuleNode.params)) return;
