...
const rule = (primary, secondaryOptions) => {
	return (root, result) => {
		...
		const ignoreMediaFeatureNameValues = Array.from(
			Object.entries(secondaryOptions?.ignoreMediaFeatureNameValues ?? {}),
		);

		/** @type {(name: string, value: string) => boolean} */
		function isNameOfValueIgnored(name, value) {
			const [, valuePattern] =
				ignoreMediaFeatureNameValues.find(([namePattern]) =>
