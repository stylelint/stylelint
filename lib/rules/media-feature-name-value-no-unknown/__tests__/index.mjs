...
testRule({
	...
	accept: [
		...
		{ code: '@media (display-mode: picture-in-picture) {}' },
...
testRule({
	ruleName,
	config: [true, { ignoreMediaFeatureNameValues: { hover: 'bar' } }],

	accept: [{ code: '@media (hover: bar) {}' }],

	reject: [
		{
			code: '@media (hover: baz) {}',
			message: messages.rejected('hover', 'baz'),
			line: 1,
			column: 16,
			endLine: 1,
			endColumn: 19,
