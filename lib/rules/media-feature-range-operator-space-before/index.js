...
const getWordStartIndex = require('../../utils/getWordStartIndex');
const getWhitespaceStartIndex = require('../../utils/getWhitespaceStartIndex');
		...
		function checkBeforeOperator(match, params, node, fix) {
			...
			checker.before({
				...
				err: (m) => {
					...
					const endIndex = paramIndex + match.startIndex;
					const index =
						primary === 'always'
							? paramIndex + getWordStartIndex(params, match.startIndex)
							: paramIndex + getWhitespaceStartIndex(params, match.startIndex, true);
