...
testRule({
	...
	accept: [
		...
		},
		{
			...
			description:
				'one unmatchable compound combination does not make the whole selector unmatchable',
		},
		{
			code: 'a:not(:checked) {}',
	...
	reject: [
		...
		},
		{
			...
			description:
				'the selector still matches via ".foo", but the unmatchable argument is reported',
			line: 1,
			column: 11,
			endLine: 1,
			endColumn: 19,
