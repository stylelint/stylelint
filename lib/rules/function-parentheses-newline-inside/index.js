			...
			parsedValue.walk((valueNode) => {
				...
				if (isMultiLine && primary === 'always-multi-line' && !containsNewline(checkBefore)) {
					if (context.fix) {
						...
						complain(messages.expectedOpeningMultiLine, openingIndex, openingEndIndex);
					}
				}
				...
				if (isMultiLine && primary === 'never-multi-line' && checkBefore !== '') {
					if (context.fix) {
						...
						complain(messages.rejectedOpeningMultiLine, openingIndex, openingEndIndex);
					}
				}
				...
				if (isMultiLine && primary === 'always-multi-line' && !containsNewline(checkAfter)) {
					if (context.fix) {
						...
						complain(messages.expectedClosingMultiLine, closingIndex, closingEndIndex);
					}
				}
				...
				if (isMultiLine && primary === 'never-multi-line' && checkAfter !== '') {
					if (context.fix) {
						...
						complain(messages.rejectedClosingMultiLine, closingIndex, closingEndIndex);
					}
				}
			});
