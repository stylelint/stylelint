...
testRule(rule, {
  ...
  reject: [
    ...
    {
      code:
        ".foo { background: -webkit-linear-gradient(to bottom, #fff, #000 ); }",
      message: messages.rejected,
      line: 1,
      column: 44
    },
    {
      code:
        ".foo { background: -moz-linear-gradient(to bottom, #fff, #000 ); }",
      message: messages.rejected,
      line: 1,
      column: 41
    },
    ...
    {
      code:
        ".foo { background: url(foo.png), -webkit-linear-gradient(to bottom, #fff, #000); }",
      message: messages.rejected,
      line: 1,
      column: 58
    },
    {
      code:
        ".foo { background: url(foo.png), -moz-linear-gradient(to bottom, #fff, #000); }",
      message: messages.rejected,
      line: 1,
      column: 55
    },
    {
      code:
        ".foo { background: url(foo.png), -o-linear-gradient(to bottom, #fff, #000); }",
      message: messages.rejected,
      line: 1,
      column: 53
    },
    {
      code:
        ".foo { background: -webkit-linear-gradient(to bottom, #fff, #000), url(foo.png); }",
      message: messages.rejected,
      line: 1,
      column: 44
    },
    {
      code:
        ".foo { background: url(foo.png), -moz-linear-gradient(to bottom, #fff, #000), url(foo.png); }",
      message: messages.rejected,
      line: 1,
      column: 55
    },
    {
      code:
        ".foo { background: -o-linear-gradient(to bottom, #fff, #000 ), url(foo.png); }",
      message: messages.rejected,
      line: 1,
      column: 39
    },
    {
      code:
        ".foo { background: url(foo.png), -webkit-linear-gradient(to bottom, #fff, #000), url(bar.png); }",
      message: messages.rejected,
      line: 1,
      column: 58
    },
    {
      code:
        ".foo { background: url(foo.png), -moz-linear-gradient(to bottom, #fff, #000), url(bar.png); }",
      message: messages.rejected,
      line: 1,
      column: 55
    },
    {
      code:
        ".foo { background: url(foo.png), -o-linear-gradient(to bottom, #fff, #000), url(bar.png); }",
      message: messages.rejected,
      line: 1,
      column: 53
    }
