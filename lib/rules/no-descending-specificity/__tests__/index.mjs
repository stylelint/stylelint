...
testRule({
	...
	reject: [
		...
		},
		{
			...
			message: messages.expectedResolved('b', '& > b', 'b', 'a > b', 1),
			line: 1,
			column: 29,
			endLine: 1,
			endColumn: 30,
		...
		},
		{
			...
			warnings: [
				{
					message: messages.expectedResolved('a', '.foo.bar &', 'a', '.foo.bar a', 1),
					line: 1,
					column: 34,
					endLine: 1,
					endColumn: 35,
				...
				{
					message: messages.expectedResolved('.foo &', '.foo.bar &', '.foo a', '.foo.bar a', 1),
					line: 1,
					column: 50,
					endLine: 1,
					endColumn: 56,
		...
		},
		{
			...
			message: messages.expectedResolved('& h2', '& h2', 'h1 h2', '.foo h2', 1),
			line: 1,
			column: 47,
			endLine: 1,
			endColumn: 51,
...
testRule({
	...
	reject: [
		{
			code: 'css` &:hover { a { color: red; } } \n a { color: red; } `;',
			message: messages.expectedResolved('a', 'a', 'a', '&:hover a', 1),
		},
		{
			code: 'css` &.active { a { color: red; } } \n a { color: red; } `;',
			message: messages.expectedResolved('a', 'a', 'a', '&.active a', 1),
		},
	],
});
