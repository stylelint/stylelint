...
testRule({
	...
	reject: [
		...
		{
			code: 'a { page-break-before: always; }',
			fixed: 'a { break-before: page; }',
			fix: { range: [4, 29], text: 'break-before: page' },
		...
		{
			code: 'a { page-break-before: always /* foo */; }',
			fixed: 'a { break-before: page /* foo */; }',
			fix: { range: [4, 29], text: 'break-before: page' },
			message: messages.expected('page-break-before', 'break-before'),
			column: 5,
			endColumn: 22,
