...
testRule(rule, {
  ...
  accept: [
    ...
    {
      code:
        "@font-face { font-family: 'foo'; src: url($variable + 'foo.ttf'); }"
    },
    {
      code:
        "@font-face { font-family: 'foo'; src: url($variable + \"foo.ttf\"); }"
    ...
    {
      code:
        "@font-face { font-family: 'foo'; src: url(\"foo.ttf\" + $variable); }"
    },
    {
      code:
        "@font-face { font-family: 'foo'; src: url('foo.ttf' + $variable); }"
    ...
    {
      code:
        "@font-face { font-family: 'foo'; src: url($variable + 'foo.ttf' + $variable); }"
    },
    {
      code:
        "@font-face { font-family: 'foo'; src: url($variable + \"foo.ttf\" + $variable); }"
...
testRule(rule, {
  ...
  reject: [
    ...
    {
      code:
        "<html><head><style>a { background: url(foo.css); }</style></head></html>",
      message: messages.expected(),
      line: 1,
      column: 40
    }
