...
testRule({
	...
	accept: [
		...
		{
			code: "a { background: url($src-prefix + '.eot?#iefix'); }",
		},
		{
			code: "a { background: url('foo.svg' crossorigin(anonymous)); }",
		},
		{
			code: 'a { background: url(foo.svg crossorigin(anonymous)); }',
		},
...
testRule({
	...
	accept: [
		...
		{
			code: 'a { background-image: url(\'data:image/svg+xml;utf8,<svg height="100" width="100">\\3c style>.cls-1{}\\3c /style></svg>\'); }',
			description:
				'data URI with embedded quotes requires quotes (#8544); escaped <style> by PostCSS v8.5.10+ (#9249)',
		},
		{
			code: 'a { background-image: url(\'data:image/svg+xml,<svg height="100" width="100">\\3c style>.cls-1{fill-rule:evenodd;}\\3c /style></svg>\'); }',
			description:
				'data URI with embedded quotes requires quotes (#8544); escaped <style> by PostCSS v8.5.10+ (#9249)',
		},
		{
