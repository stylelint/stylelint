...
testRule({
	...
	reject: [
		...
		},
		{
			...
			description: 'empty selectors in functional pseudo selectors do not multiply reports',
			line: 1,
			column: 1,
			endLine: 1,
			endColumn: 2,
		...
		{
			code: 'a:is(:is(.b, .c), :is(.d, .e)) {}',
			warnings: [
				{
					message: messages.rejected('a:is(:is(.b, .c), :is(.d, .e))', 'a'),
					line: 1,
					column: 1,
					endLine: 1,
					endColumn: 2,
