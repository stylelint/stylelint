...
testRule({
	...
	reject: [
		{
			code: 'div#thing { }',
			message: messages.rejected('div', 'div#thing'),
			// line: 1,
			// column: 1,
			// endLine: 1,
			// endColumn: 10,
		...
		},
		{
			...
			message: messages.rejected('div', 'div:hover#thing'),
			// line: 1,
			// column: 1,
			// endLine: 1,
			// endColumn: 16,
		...
		{
			code: 'ul.list { }',
			message: messages.rejected('ul', 'ul.list'),
			// line: 1,
			// column: 1,
			// endLine: 1,
			// endColumn: 8,
		...
		},
		{
			...
			message: messages.rejected('ul', 'ul.list.list--modifier'),
			// line: 1,
			// column: 1,
			// endLine: 1,
			// endColumn: 23,
		...
		{
			code: "a[href='place'] { }",
			message: messages.rejected('a', "a[href='place']"),
			// line: 1,
			// column: 1,
			// endLine: 1,
			// endColumn: 16,
...
testRule({
	...
	reject: [
		...
		},
		{
			...
			message: messages.rejected('div', 'div.class#thing'),
			// 	line: 1,
			// 	column: 1,
		},
		{
		...
		},
		{
			...
			message: messages.rejected('a', "a.class[data='place']"),
			// 	line: 1,
			// 	column: 1,
		},
		{
...
testRule({
	...
	reject: [
		...
		},
		{
			...
			message: messages.rejected('div', 'div[target]#thing'),
			// 	line: 1,
			// 	column: 1,
		},
		{
			code: 'div[target=_blank]#thing { }',
			message: messages.rejected('div', 'div[target=_blank]#thing'),
			// 	line: 1,
			// 	column: 1,
		},
		{
		...
		},
		{
			...
			message: messages.rejected('ul', 'ul[target].class'),
			// 	line: 1,
			// 	column: 1,
		},
		{
			code: 'ul[target=_blank].class { }',
			message: messages.rejected('ul', 'ul[target=_blank].class'),
			// 	line: 1,
			// 	column: 1,
		},
		{
...
testRule({
	...
	reject: [
		{
			code: 'a { &[attribute] {} }',
			message: messages.rejected('a', 'a[attribute]'),
			// line: 1,
			// column: 5,
			// endLine: 1,
			// endColumn: 17,
		...
		{
			code: 'a { &.class {} }',
			message: messages.rejected('a', 'a.class'),
			// line: 1,
			// column: 5,
			// endLine: 1,
			// endColumn: 12,
		...
		{
			code: 'a { &#id {} }',
			message: messages.rejected('a', 'a#id'),
			// line: 1,
			// column: 5,
			// endLine: 1,
			// endColumn: 9,
		},
		{
			...
			message: messages.rejected('a', '[attribute]:is(div a)'),
			// line: 1,
			// column: 9,
			// endLine: 1,
			// endColumn: 21,
		...
		{
			code: 'div a { &.class {} }',
			message: messages.rejected('a', '.class:is(div a)'),
			// line: 1,
			// column: 9,
			// endLine: 1,
			// endColumn: 16,
		...
		{
			code: 'div a { &#id {} }',
			message: messages.rejected('a', '#id:is(div a)'),
			// line: 1,
			// column: 9,
			// endLine: 1,
			// endColumn: 13,
...
testRule({
	...
	reject: [
		...
		},
		{
			...
			message: messages.rejected('a', '#id:is(div div a)'),
			// line: 3,
			// column: 3,
			// endLine: 3,
			// endColumn: 7,
...
testRule({
	...
	reject: [
		...
		{
			code: 'a:is([attribute]) {}',
			message: messages.rejected('a', 'a:is([attribute])'),
			line: 1,
			column: 1,
			endLine: 1,
			endColumn: 2,
		},
		{
			...
			warnings: [
				{
					message: messages.rejected('b', ':is(a, [attribute]):is(b, .class)'),
					line: 1,
					column: 26,
					endLine: 1,
					endColumn: 27,
				...
				{
					message: messages.rejected('a', ':is(a, [attribute]):is(b, .class)'),
					line: 1,
					column: 7,
					endLine: 1,
					endColumn: 8,
		...
		{
			code: '[attribute]:is(a) {}',
			message: messages.rejected('a', '[attribute]:is(a)'),
			line: 1,
			column: 16,
			endLine: 1,
			endColumn: 17,
