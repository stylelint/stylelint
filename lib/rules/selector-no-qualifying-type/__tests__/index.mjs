...
testRule({
	...
	accept: [
		...
		{
			code: '.form-field:has(input:disabled) {}',
			description: 'type selector with pseudo-class inside :has() (from issue report)',
		},
		{
			code: '.foo:has(a.bar) {}',
			description: 'qualified type selector inside :has() does not qualify the current element',
		},
	],
