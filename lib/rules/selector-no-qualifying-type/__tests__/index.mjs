...
testRule({
	...
	reject: [
		...
		},
		{
			...
			message: messages.rejected('[attribute]:is(div a)'),
			line: 1,
			column: 9,
			endLine: 1,
			endColumn: 21,
		...
		{
			code: 'div a { &.class {} }',
			message: messages.rejected('.class:is(div a)'),
			line: 1,
			column: 9,
			endLine: 1,
			endColumn: 16,
		...
		{
			code: 'div a { &#id {} }',
			message: messages.rejected('#id:is(div a)'),
			line: 1,
			column: 9,
			endLine: 1,
			endColumn: 13,
...
testRule({
	...
	reject: [
		...
		},
		{
			...
			message: messages.rejected('#id:is(div div a)'),
			line: 3,
			column: 3,
			endLine: 3,
			endColumn: 7,
