...
testRule({
	...
	accept: [
		...
		{
			code: 'a { color: lch(from red 1 1 1deg) }',
		},
		{
			code: 'a { color: hsl(from red 1deg 1 1) }',
		},
		{
			code: 'a { color: oklch(from red 1 1 1deg) }',
		},
		{
			code: 'a { color: oklch(from red l c h) }',
		},
		{
			code: 'a { color: oklch(from hsl(270deg 60% 50%) l c h) }',
		},
	],
	...
	reject: [
		...
		{
			code: 'a { color: oklch(from red l c 10) }',
			fixed: 'a { color: oklch(from red l c 10deg) }',
			fix: {
				range: [31, 32],
				text: '0deg',
			},
		...
		{
			code: 'a { color: hsl(from red 10 s l) }',
			fixed: 'a { color: hsl(from red 10deg s l) }',
			fix: {
				range: [25, 26],
				text: '0deg',
			},
		...
		{
			code: 'a { color: hsl(from hsl(10 60% 50%) h s l) }',
			fixed: 'a { color: hsl(from hsl(10deg 60% 50%) h s l) }',
			fix: {
				range: [25, 26],
				text: '0deg',
			},
...
testRule({
	...
	accept: [
		...
		{
			code: 'a { color: hsl(from red 270 60% 50%) }',
		},
		{
			code: 'a { color: hsl(from red h s l) }',
		},
		{
			code: 'a { color: oklch(from red l c 40) }',
		},
	],
	...
	reject: [
		...
		{
			code: 'a { color: oklch(from red l c 10deg) }',
			fixed: 'a { color: oklch(from red l c 10) }',
			fix: {
				range: [32, 35],
				text: '',
			},
		...
		{
			code: 'a { color: hsl(from red 120deg s l) }',
			fixed: 'a { color: hsl(from red 120 s l) }',
			fix: {
				range: [27, 30],
				text: '',
			},
