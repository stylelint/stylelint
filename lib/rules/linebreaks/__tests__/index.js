...
testRule(rule, {
	...
	reject: [
		...
		},
		{
			...
			fixed: '/*This is a\ncomment*/\na {}',
			message: messages.expected('unix'),
			description: 'CRLF inside a comment string without spaces in the beggining in the first line',
			line: 1,
			column: 12,
		},
		{
...
testRule(rule, {
	...
	reject: [
		...
		},
		{
			...
			fixed: '/*This is a\r\ncomment*/\r\na {}',
			message: messages.expected('windows'),
			description: 'LF inside a comment string without spaces in the beggining in the first line',
			line: 1,
			column: 12,
		},
		{
