...
testRule({
	...
	reject: [
		...
		},
		{
			...
			endLine: 1,
			endColumn: 17,
			fix: { range: [10, 32], text: '400 16px/3 cursive' },
		},
		{
			...
			endLine: 1,
			endColumn: 17,
			fix: { range: [10, 39], text: '400 normal 16px/3 cursive' },
		},
		{
			...
			endLine: 1,
			endColumn: 17,
			fix: { range: [10, 46], text: '400 normal normal 16px/3 cursive' },
		},
		{
		...
		},
		{
			...
			endLine: 1,
			endColumn: 33,
			fix: { range: [26, 46], text: '400 /* 400 */700' },
		},
		{
			code: '@font-face { font-weight: normal/* 400 */ 700; }',
			fixed: '@font-face { font-weight: 400/* 400 */ 700; }',
...
testRule({
	...
	reject: [
		...
		},
		{
			...
			endLine: 1,
			endColumn: 32,
			fix: { range: [28, 47], text: 'bold 16px/3 cursive' },
		},
		{
			code: 'a { font: normal 400 normal 16px serif; }',
			...
			endLine: 1,
			endColumn: 21,
			fix: { range: [17, 39], text: 'normal normal 16px serif' },
		},
		{
			code: 'a { font: 400 normal 16px serif; }',
			...
			endLine: 1,
			endColumn: 14,
			fix: { range: [10, 32], text: 'normal normal 16px serif' },
		},
		{
			code: 'a { font: 400 16px serif; }',
			...
			endLine: 1,
			endColumn: 14,
			fix: { range: [10, 25], text: 'normal 16px serif' },
		},
	],
});
