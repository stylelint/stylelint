...
const validateObjectWithNestedProps = require('../../utils/validateObjectWithNestedProps.cjs');
		...
		const validOptions = validateOptions(
			...
			{ actual: primary },
			{
				...
				possible: {
					...
					atRulesSyntax: [validateObjectWithNestedProps(validateTypes.isString, validateTypes.isNullish)],
