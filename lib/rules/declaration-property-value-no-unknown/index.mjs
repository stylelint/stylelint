	...
	return (root, result) => {
		...
		if (secondaryOptions?.propertiesSyntax) {
			emitDeprecationWarning(
				`The "propertiesSyntax" option of "${ruleName}" is deprecated.`,
				'RULE_OPTION',
				'Use the "languageOptions" configuration property instead. See https://stylelint.io/user-guide/rules/declaration-property-value-no-unknown#propertiessyntax for migration.',
			);
		}

		if (secondaryOptions?.typesSyntax) {
			emitDeprecationWarning(
				`The "typesSyntax" option of "${ruleName}" is deprecated.`,
				'RULE_OPTION',
				'Use the "languageOptions" configuration property instead. See https://stylelint.io/user-guide/rules/declaration-property-value-no-unknown#typessyntax for migration.',
			);
		}
