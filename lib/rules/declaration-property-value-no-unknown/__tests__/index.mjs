...
testRule({
	...
	reject: [
		...
		},
		{
			...
			message: messages.rejectedMath('height', 'calc(min(1px + 1, 2px))'),
			line: 1,
			column: 13,
			endLine: 1,
			endColumn: 36,
		...
		},
		{
			...
			message: messages.rejectedMath('height', 'min(calc(1px + 1), 2px)'),
			line: 1,
			column: 13,
			endLine: 1,
			endColumn: 36,
		...
		},
		{
			...
			message: messages.rejectedMath('height', 'max(calc(10px + 1), 5px)'),
			line: 1,
			column: 13,
			endLine: 1,
			endColumn: 37,
		...
		},
		{
			...
			message: messages.rejectedMath('height', 'calc(max(10px, 5px) + 2 + 3px)'),
			line: 1,
			column: 13,
			endLine: 1,
			endColumn: 43,
		...
		},
		{
			...
			message: messages.rejectedMath('height', 'min(1px + 2, 5px)'),
			line: 1,
			column: 13,
			endLine: 1,
			endColumn: 30,
		...
		},
		{
			...
			message: messages.rejectedMath('height', 'clamp(1px, 2 + 3px, 10px)'),
			line: 1,
			column: 13,
			endLine: 1,
			endColumn: 38,
		...
		},
		{
			...
			message: messages.rejectedMath('width', 'calc(10% - 5)'),
			line: 1,
			column: 12,
			endLine: 1,
			endColumn: 25,
		...
		},
		{
			...
			message: messages.rejectedMath('background', 'calc(10px + 1)'),
			line: 1,
			column: 30,
			endLine: 1,
			endColumn: 44,
		...
		{
			code: 'a { width: image-set(calc(1px + 1) 1x) calc(2px + 3); }',
			message: messages.rejectedMath('width', 'calc(1px + 1)'),
			line: 1,
			column: 22,
			endLine: 1,
			endColumn: 35,
		...
		},
		{
			...
			message: messages.rejectedMath('width', 'calc(3 - 1px)'),
			line: 1,
			column: 39,
			endLine: 1,
			endColumn: 52,
	...
	reject: [
		{
			...
			endLine: 1,
			endColumn: 17,
			description: 'languageOptions with empty syntax object - rejects unknown value',
		},
	],
});
...
testRuleConfigs({
	...
	reject: [
		{
			config: [true, { ignoreProperties: 'invalid' }],
			description: 'invalid ignoreProperties option type',
		},
		{
			config: [true, { propertiesSyntax: 123 }],
			description: 'invalid propertiesSyntax option type',
		},
		{
			config: [true, { typesSyntax: 123 }],
			description: 'invalid typesSyntax option type',
		},
	],
});
