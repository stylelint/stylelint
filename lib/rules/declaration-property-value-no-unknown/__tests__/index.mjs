...
testRule({
	...
	reject: [
		...
		},
		{
			...
			message: messages.rejectedMath('height', 'min(1px + 1, 2px)'),
			line: 1,
			column: 18,
			endLine: 1,
			endColumn: 35,
		...
		},
		{
			...
			message: messages.rejectedMath('height', 'calc(1px + 1)'),
			line: 1,
			column: 17,
			endLine: 1,
			endColumn: 30,
		...
		},
		{
			...
			message: messages.rejectedMath('height', 'calc(10px + 1)'),
			line: 1,
			column: 17,
			endLine: 1,
			endColumn: 31,
		...
		},
		{
			...
			message: messages.rejectedMath('background', 'calc(1px + 1)'),
			line: 1,
			column: 27,
			endLine: 1,
			endColumn: 40,
		...
		},
		{
			...
			message: messages.rejectedMath('margin-inline', 'calc(3 - 1px)'),
			line: 1,
			column: 36,
			endLine: 1,
			endColumn: 49,
