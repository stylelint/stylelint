...
testRule({
	...
	reject: [
		...
		},
		{
			...
			message: messages.rejectedValueFunction('color', 'rgb(67 67 67 70%)'),
			line: 1,
			column: 12,
			endLine: 1,
			endColumn: 29,
		},
		{
			...
			message: messages.rejectedValueFunction('box-shadow', 'rgba(#ff611d, 0.5)'),
			line: 1,
			column: 29,
			endLine: 1,
			endColumn: 47,
		...
		},
		{
			...
			message: messages.rejectedValueFunction('color', 'hsl(#ff611d, 50%, 50%)'),
			line: 1,
			column: 12,
			endLine: 1,
			endColumn: 34,
		...
		},
		{
			...
			message: messages.rejectedValueFunction(
				'background-color',
		...
		},
		{
			...
			message: messages.rejectedValueFunction('background', 'rgba(255, 255)'),
			line: 1,
			column: 17,
			endLine: 1,
			endColumn: 31,
