...
testRule({
	...
	accept: [
		{
			code: '@example my-ident { foo: 42; }',
		},
	],

	reject: [
		{
			code: '@example my-ident { foo: red; }',
			message: messages.rejected('foo', 'red'),
			line: 1,
			column: 26,
			endLine: 1,
			endColumn: 29,
		...
		{
			code: '@example 10px { foo: 42; }',
			message: messages.rejected('example', '10px'),
			line: 1,
			column: 10,
			endLine: 1,
			endColumn: 14,
...
testRule({
	...
	config: [
		true,
		{
			cssWideKeywords: ['my-keyword'],
		},
	],

	accept: [
		{
			code: 'a { color: my-keyword; }',
		},
	],

	reject: [
		{
			code: 'a { color: invalid-keyword; }',
			message: messages.rejected('color', 'invalid-keyword'),
			line: 1,
			column: 12,
			endLine: 1,
			endColumn: 27,
