...
/**
 * @param {import('postcss/lib/comment')} comment
 * @param {number} start
 * @param {boolean} strictStart
 * @param {string|undefined} description
 * @param {number} [end]
 * @param {boolean} [strictEnd]
 * @returns {import('stylelint').DisabledRange}
 */
 ...
 * @returns {import('stylelint').PostcssResult}
 */
module.exports = function (root, result) {
	 ...
	 * @type {import('stylelint').DisabledRangeObject}
	 */
	...
	/** @type {import('postcss/lib/comment')?} */
	let inlineEnd;

	root.walkComments((/** @type {import('postcss/lib/comment')} */ comment) => {
		if (inlineEnd) {
