...
describe('isAutoprefixable.property()', () => {
	it('returns true', () => {
		...
		expect(isAutoprefixable.property('-webkit-background-clip')).toBe(true);
		expect(isAutoprefixable.property('-webkit-background-clip', 'content-box')).toBe(true);
	});

	it('returns false', () => {
		expect(isAutoprefixable.property('transition')).toBe(false);
		expect(isAutoprefixable.property('-webkit-touch-callout')).toBe(false);
		expect(isAutoprefixable.property('-webkit-background-clip', 'text')).toBe(false);
	});
});
