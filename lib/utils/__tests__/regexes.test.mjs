...
describe('atRuleRegexes', () => {
	...
	it('matches "syntax" case-insensitively', () => {
		expect(atRuleRegexes.syntax.test('syntax')).toBe(true);
		expect(atRuleRegexes.syntax.test('Syntax')).toBe(true);
		expect(atRuleRegexes.syntax.test('SYNTAX')).toBe(true);
		expect(atRuleRegexes.syntax.test('syn')).toBe(false);
		expect(atRuleRegexes.syntax.test('syntax-value')).toBe(false);
	});
