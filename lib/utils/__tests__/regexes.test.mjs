...
describe('atRuleRegexes', () => {
	...
	it('matches "syntax" case-insensitively', () => {
		expect(atRuleRegexes.import.test('syntax')).toBe(true);
		expect(atRuleRegexes.import.test('Syntax')).toBe(true);
		expect(atRuleRegexes.import.test('SYNTAX')).toBe(true);
		expect(atRuleRegexes.import.test('syn')).toBe(false);
		expect(atRuleRegexes.import.test('syntax-value')).toBe(false);
	});
