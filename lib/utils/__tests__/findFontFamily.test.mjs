import findFontFamily from '../findFontFamily.mjs';
...
it('findFontFamily', () => {
	...
	expect(findFontFamily('12px math')).toEqual([
		{
			sourceEndIndex: 9,
			sourceIndex: 5,
			type: 'word',
	...
	expect(findFontFamily('math, math')).toEqual([
		{
			sourceEndIndex: 4,
			sourceIndex: 0,
			type: 'word',
	...
	expect(findFontFamily('math / normal math')).toEqual([
		{
			sourceEndIndex: 18,
			sourceIndex: 14,
			type: 'word',
	...
	expect(findFontFamily('math math, math')).toEqual([
		{
			sourceEndIndex: 9,
			sourceIndex: 5,
			type: 'word',
	...
	expect(findFontFamily('12px serif, math font')).toEqual([
		{
			sourceEndIndex: 10,
			sourceIndex: 5,
			type: 'word',
