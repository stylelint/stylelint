...
it('handles complex selectors', () => {
	expect(normalizeSelector(parseSelector('.a.b {} .b.a {}')).toString()).toBe('.a.b {} .a.b {}');

	expect(normalizeSelector(parseSelector('.a.b::before {} .b.a::before {}')).toString()).toBe(
		'.a.b::before {} .a.b::before {}',
	);

	expect(
		normalizeSelector(parseSelector('a.b#c[attr="foo"] {} a[attr="foo"]#c.b {}')).toString(),
	).toBe('a#c.b[attr="foo"] {} a#c.b[attr="foo"] {}');

	expect(
		normalizeSelector(
			parseSelector(':is(.b, .a)#c[attr="foo"] {} :is(.a, .b)[attr="foo"]#c {}'),
		).toString(),
	).toBe('#c[attr="foo"]:is(.a,.b) {} #c[attr="foo"]:is(.a,.b) {}');
});
