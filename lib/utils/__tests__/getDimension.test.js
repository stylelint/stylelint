...
it('getDimension', () => {
	...
	expect(getDimension(valueParser('#fff').nodes[0])).toBeNull();
	expect(getDimension(valueParser('#000').nodes[0])).toBeNull();
	expect(getDimension(valueParser('#zzzzzz').nodes[0])).toBeNull();
	expect(getDimension(valueParser('#F').nodes[0])).toBeNull();
	expect(getDimension(valueParser('#PX').nodes[0])).toBeNull();
	expect(getDimension(valueParser('"100"').nodes[0])).toBeNull();
	expect(getDimension(valueParser('"100px"').nodes[0])).toBeNull();
	expect(getDimension(valueParser(' ').nodes[0])).toBeNull();
	expect(getDimension(valueParser('/').nodes[0])).toBeNull();
	expect(getDimension(valueParser('+').nodes[0])).toBeNull();
	expect(getDimension(valueParser('word').nodes[0])).toBeNull();
	expect(getDimension(valueParser('px').nodes[0])).toBeNull();
	expect(getDimension(valueParser('url()').nodes[0])).toBeNull();
	expect(getDimension(valueParser('url()px').nodes[0])).toBeNull();
	expect(getDimension(valueParser('$variable').nodes[0])).toBeNull();
	expect(getDimension(valueParser('${$variable}').nodes[0])).toBeNull();
	expect(getDimension(valueParser('${$variable}px').nodes[0])).toBeNull();
	expect(getDimension(valueParser('${$variable}px').nodes[0])).toBeNull();
	expect(getDimension(valueParser('@variable').nodes[0])).toBeNull();
	expect(getDimension(valueParser('e1').nodes[0])).toBeNull();
	expect(getDimension(valueParser('wordPX').nodes[0])).toBeNull();
	expect(getDimension(valueParser('..0').nodes[0])).toBeNull();
});
