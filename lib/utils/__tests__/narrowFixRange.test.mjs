...
describe('narrowFixRange', () => {
	...
	describe('insert', () => {
		...
		test('declaration with trailing semicolon', () => {
			const node = postcss.parse('a { opacity: 45%; }');
		...
		test('atrule with trailing semicolon', () => {
			const node = postcss.parse('@keyframes name { a { opacity: 45% }; to { top: 0.7 };};');
			...
			expect(
				applyFixData(
					'@keyframes name { a { opacity: 45% }; to { top: 0.7 };};',
					narrowRange.text,
					narrowRange.range,
				),
			).toBe('@keyframes name { a { opacity: 0.45 }; to { top: 0.7 };};');
		});
