...
describe('beforeBlockString', () => {
	...
	it('runs with comment between selectors', () => {
		expect(postcssCheck('a /* x */, span\n{}')).toBe('a /* x */, span\n');
	});

	it('runs with comment between at-rule rules', () => {
		expect(postcssCheck('@media print, /* x */ screen\n{}')).toBe('@media print, /* x */ screen\n');
	});
