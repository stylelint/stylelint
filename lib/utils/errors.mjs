import { EXIT_CODE_INVALID_CONFIG, EXIT_CODE_LINT_PROBLEM } from '../constants.mjs';
...
export class UnusedSuppressionsError extends Error {
	name = 'UnusedSuppressionsError';

	code = EXIT_CODE_LINT_PROBLEM;
