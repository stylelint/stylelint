...
function isFixApplied(problem) {
	const { end, start, index, endIndex, fix, node, result, ruleName, unfixable } = problem;
	...
	} else if (hasRangeData && unfixable) {
		addFixData({ fixersData, ruleName, range, fixed: false });
	}
