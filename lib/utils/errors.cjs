...
class SuppressionFileNotFoundError extends Error {
	...
	code = constants.EXIT_CODE_FATAL_ERROR;
...
class UnusedSuppressionsError extends Error {
	name = 'UnusedSuppressionsError';

	code = constants.EXIT_CODE_LINT_PROBLEM;
...
exports.UnusedSuppressionsError = UnusedSuppressionsError;
