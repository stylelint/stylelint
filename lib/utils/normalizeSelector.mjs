...
function normalizeNodeEscaping(node) {
	// Self-assignment triggers the setter which normalizes CSS escaping.
...
export default function normalizeSelector(node) {
	// Normalize CSS escape sequences so that equivalent selectors match
	normalizeNodeEscaping(node);
	node.walk(normalizeNodeEscaping);
