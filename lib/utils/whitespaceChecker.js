...
module.exports = function(targetWhitespace, expectation, messages) {
	...
	*/
	 ...
	 */
	function expectBefore(messageFunc) {
	 ...
	 * @param {Function} [messageFunc]
	 */
	function expectBeforeAllowingIndentation(messageFunc) {
		messageFunc = messageFunc || messages.expectedBefore;
	 ...
	 * @param {Function} [messageFunc]
	 */
	function rejectBefore(messageFunc) {
	 ...
	 * @param {Function} [messageFunc]
	 */
	function expectAfter(messageFunc) {
	 ...
	 * @param {Function} [messageFunc]
	 */
	function rejectAfter(messageFunc) {
