 ...
 *
 * @param {Pick<LinterOptions, 'ignorePath' | 'ignorePattern'> & { cwd: string, ignorePatterns?: string[] }} options
 * @return {import('ignore').Ignore}
 */
module.exports = function getFileIgnorer({ ignorePath, ignorePattern, ignorePatterns, cwd }) {
	...
	if (ignorePatterns) ignorer.add(ignorePatterns);
