 ...
 */
function nodeRangeBy(node, opts) {
	if (!node) return;
	...
	if (validateTypes.isNumber(opts.index)) {
	...
	if (validateTypes.isNumber(opts.endIndex)) {
		end = positionInside(opts.endIndex, inputCSS, sourceStart);
	} else if (validateTypes.isNumber(opts.index)) {
