...
function mergeConfigs(a, b) {
	...
	const extensionsMerger = {};

	if (a.extensions || b.extensions) {
		extensionsMerger.extensions = [...new Set((a.extensions || []).concat(b.extensions || []))];
	}
...
function addOptions(stylelint, config) {
	...
	if (stylelint._options.extensions) {
		augmentedConfig.extensions = stylelint._options.extensions;
	}

	return augmentedConfig;
}

module.exports = { augmentConfigExtended, augmentConfigFull, applyOverrides, extendConfig };
