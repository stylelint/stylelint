...
import validateGlobOptions from './utils/validateGlobOptions.mjs';
...
export default async function standalone({
	...
	validateGlobOptions(globOptions);
	...
	let filePaths = await glob(fileList, { cwd, dot: globOptions?.dot, absolute: true });
