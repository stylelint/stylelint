...
describe('standalone with fix options for CSS syntax errors', () => {
	const cssWithSyntaxError = '// comment';
	const cssIncompleteRule = 'a {';
	const cssNonSyntaxError = stripIndent`
    a { colr: hsl(20, 10%, 30%, 5%); }
  `;
	const expectedFixedCode = stripIndent`
    a { colr: hsl(20deg 10% 30% / 5%); }
  `;
	const config = {
		rules: {},
	};
