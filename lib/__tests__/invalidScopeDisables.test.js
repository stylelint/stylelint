...
it.only('invalidScopeDisables complex case', () => {
	const config = {
		rules: {
			'block-no-empty': true,
		},
	...
	console.log(`fixture('disabled-ranges-1.css')`, fixture('disabled-ranges-1.css'));
	console.log(`fixture('disabled-ranges-2.css')`, fixture('disabled-ranges-2.css'));
