	...
	suite('plugin', () => {
		...
		test('node', async () => {
			return expect(
				...
				'The "plugin/selector-no-qux" rule failed to provide correct position arguments to the `utils.report()` function. Provide a PostCSS `node` to the `utils.report()` function.',
			);
		});
