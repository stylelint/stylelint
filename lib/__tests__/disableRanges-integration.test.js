...
testRule(maxLines, {
  ruleName: maxLines.ruleName,
  config: 1,
  skipBasicChecks: true,

  accept: [
    {
      code: "/* stylelint-disable max-lines */\r\n.a { color: red; }",
    ...
    {
      code:
        ".a { color: red; } /* stylelint-disable max-lines */\r\n.b { color: green; }",
      description: "count = 2 (CRLF)"
    },
    {
      code:
  ...
  reject: [
    {
      code: ".a { color: red; }\r\n/* stylelint-disable max-lines */",
      description: "count = 2 (CRLF)",
      message: maxLines.messages.expected(1, 2)
    },
    {
      code: ".a { color: red; }\n/* stylelint-disable max-lines */",
      description: "count = 2 (LF)",
