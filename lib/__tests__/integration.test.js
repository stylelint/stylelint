...
describe("integration test expecting warnings", () => {
  ...
  it("declaration-property-unit-blacklist - object primary option", () => {
    expect(result.messages[1].text).toBe("Unexpected unit \"px\" for property \"width\" (declaration-property-unit-blacklist)")
  ...
  it("function-blacklist - array primary option", () => {
    expect(result.messages[4].text).toBe("Unexpected function \"calc\" (function-blacklist)")
