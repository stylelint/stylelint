...
describe('CLI', () => {
	...
	// TODO: This case fails on Node.js 18. Restore the case when dropping the support for Node.js 18.
	...
	it('--custom-formatter with filesystem path', async () => {
		await cli([
			`--custom-formatter=${fixturesPath('formatters/customFormatter.cjs')}`,
			'--config',
			fixturesPath('default-severity-warning.json'),
			fixturesPath('empty-block.css'),
		]);
