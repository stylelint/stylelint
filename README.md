...
[![CI](https://github.com/stylelint/stylelint/actions/workflows/ci.yml/badge.svg)](https://github.com/stylelint/stylelint/actions/workflows/ci.yml)
...
- Migration guide
  - [Migrating to 18.0.0](docs/migration-guide/to-18.md)
