...
-   **Support for plugins:** It's easy to [create your own rules](docs/developer-guide/plugins.md) and [add them to the linter](docs/user-guide/configuration.md#plugins), or make use of [plugins written by the community](docs/user-guide/plugins.md).
-   **Automatically fixes some stylistic violations:** Save time by [having stylelint fix your code](docs/user-guide/cli.md#autofixing-errors) with this *experimental* feature.
-   **Shareable configs:** If you don't want to [craft your own config](docs/user-guide/about-rules.md), you can [extend a shareable config](docs/user-guide/configuration.md#extends). Or you can craft your own config and share with your team and/or the community].
