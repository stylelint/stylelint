			...
			warnings: [
				{
					...
					endLine: 2,
					line: 2,
					rule: 'comment-pattern',
					severity: 'error',
					text: 'Expected comment to match pattern "/regex/" (comment-pattern)',
				},
				{
					column: 16,
					endColumn: 17,
				...
				},
				{
					...
					endLine: 2,
					line: 2,
					rule: 'property-allowed-list',
					severity: 'error',
					text: 'Unexpected property "color" (property-allowed-list)',
				},
				{
					column: 2,
					endColumn: 7,
					endLine: 2,
					line: 2,
					rule: 'rule-selector-property-disallowed-list',
					severity: 'error',
					text: 'Unexpected property "color" for selector "a" (rule-selector-property-disallowed-list)',
				},
			],
		},
	],
